...
int precedencia(char op1, char op2){
    /*bool sumaResta = op1 == '+' && op2 == '-' || op1 == '-' && op2 == '+';
    bool multDiv = op1 == '*' && op2 == '/' || op1 == '/' && op2 == '*';
    bool multMod = op1 == '*' && op2 == '%' || op1 == '%' && op2 == '*';
    bool divMod = op1 == '/' && op2 == '%' || op1 == '%' && op2 == '/';
    if(sumaResta || multDiv || multMod || divMod || op1 == op2)
        return 0;*/
